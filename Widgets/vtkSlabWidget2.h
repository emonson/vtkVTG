/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlabWidget2.h,v $
...
=========================================================================*/
// .NAME vtkSlabWidget2 - 3D widget for manipulating a box
// .SECTION Description
// This 3D widget interacts with a vtkSlabRepresentation class (i.e., it
...
// object rotation or scaling. A nice feature of vtkSlabWidget2, like any 3D
// widget, will work with the current interactor style. That is, if
// vtkSlabWidget2 does not handle an event, then all other registered
// observers (including the interactor style) have an opportunity to process
// the event. Otherwise, the vtkSlabWidget will terminate the processing of
// the event that it handles.
//
// To use this widget, you generally pair it with a vtkSlabRepresentation
...
// into the vtkSlabWidget2's widget events:
// <pre>
...
// </pre>
//
// In turn, when these widget events are processed, the vtkSlabWidget2
...
// 
// This class, and the affiliated vtkSlabRepresentation, are second generation
// VTK widgets. An earlier version of this functionality was defined in the
// class vtkSlabWidget.

// .SECTION See Also
// vtkSlabRepresentation vtkSlabWidget

#ifndef __vtkSlabWidget2_h
#define __vtkSlabWidget2_h

#include "vtkAbstractWidget.h"

class vtkSlabRepresentation;
class vtkHandleWidget;


class VTK_WIDGETS_EXPORT vtkSlabWidget2 : public vtkAbstractWidget
{
public:
  // Description:
  // Instantiate the object.
  static vtkSlabWidget2 *New();

  // Description:
  // Standard class methods for type information and printing.
  vtkTypeRevisionMacro(vtkSlabWidget2,vtkAbstractWidget);
  ...
  void SetRepresentation(vtkSlabRepresentation *r)
  ...
  // this is an instance of the vtkSlabRepresentation class.
...
//ETX
  ...
  int RotationEnabled;
private:
  vtkSlabWidget2(const vtkSlabWidget2&);  //Not implemented
  void operator=(const vtkSlabWidget2&);  //Not implemented
};
