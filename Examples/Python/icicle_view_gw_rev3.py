...
paf.SetInput(tree_to_poly.GetOutput())
...
# Send the geometry with TCoords into pipeline
map0.RemoveInputConnection(0,tree_to_poly.GetOutputPort(0))
map0.SetInputConnection(paf.GetOutputPort(0))
act0.SetTexture(tex)
