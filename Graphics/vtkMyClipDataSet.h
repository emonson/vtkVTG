/*=========================================================================
  ...
  Module:    $RCSfile: vtkMyClipDataSet.h,v $
...
=========================================================================*/
// .NAME vtkMyClipDataSet - clip any dataset with user-specified implicit function or input scalar data
// .SECTION Description
// vtkMyClipDataSet is a filter that clips any type of dataset using either
...
// .SECTION Caveats
// vtkMyClipDataSet will triangulate all types of 3D cells (i.e., create
...
#ifndef __vtkMyClipDataSet_h
#define __vtkMyClipDataSet_h
...
class VTK_GRAPHICS_EXPORT vtkMyClipDataSet : public vtkUnstructuredGridAlgorithm
{
public:
  vtkTypeRevisionMacro(vtkMyClipDataSet,vtkUnstructuredGridAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Construct with user-specified implicit function; InsideOut turned off;
  // value set to 0.0; and generate clip scalars turned off.
  static vtkMyClipDataSet *New();
...
protected:
  vtkMyClipDataSet(vtkImplicitFunction *cf=NULL);
  ~vtkMyClipDataSet();
...
private:
  vtkMyClipDataSet(const vtkMyClipDataSet&);  // Not implemented.
  void operator=(const vtkMyClipDataSet&);  // Not implemented.
};
