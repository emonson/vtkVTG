/*=========================================================================
  ...
  Module:    $RCSfile: vtkMyGlyph3D.h,v $
...
=========================================================================*/
// .NAME vtkMyGlyph3D - copy oriented and scaled glyph geometry to every input point
// .SECTION Description
// vtkMyGlyph3D is a filter that copies a geometric representation (called
...
#ifndef __vtkMyGlyph3D_h
#define __vtkMyGlyph3D_h
...
class VTK_GRAPHICS_EXPORT vtkMyGlyph3D : public vtkPolyDataAlgorithm
{
public:
  vtkTypeRevisionMacro(vtkMyGlyph3D,vtkPolyDataAlgorithm);
  ...
  vtkSetMacro(ScaleXfactor,double);
  vtkGetMacro(ScaleXfactor,double);

  // Description:
  // Specify scale factor to scale object by.
  vtkSetMacro(ScaleYZfactor,double);
  vtkGetMacro(ScaleYZfactor,double);
...
protected:
  ...
  double ScaleXfactor; // Scale factor to use to scale geometry in X-dir
  double ScaleYZfactor; // Scale factor for geometry in Y an Z-dirs
...
private:
  vtkMyGlyph3D(const vtkMyGlyph3D&);  // Not implemented.
  void operator=(const vtkMyGlyph3D&);  // Not implemented.
};

// Description:
// Return the method of scaling as a descriptive character string.
inline const char *vtkMyGlyph3D::GetScaleModeAsString(void)
{
...
inline const char *vtkMyGlyph3D::GetColorModeAsString(void)
{
...
inline const char *vtkMyGlyph3D::GetVectorModeAsString(void)
{
...
inline const char *vtkMyGlyph3D::GetIndexModeAsString(void)
{
