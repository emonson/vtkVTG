...
=========================================================================*/
// .NAME vtkSlab - implicit function for a bounding box
// .SECTION Description
// vtkSlab computes the implicit function and/or gradient for a axis-aligned
...
class VTK_COMMON_EXPORT vtkSlab : public vtkImplicitFunction
{
public:
  vtkTypeRevisionMacro(vtkSlab,vtkImplicitFunction);
...
private:
  vtkSlab(const vtkSlab&);  // Not implemented.
  void operator=(const vtkSlab&);  // Not implemented.
};



inline void vtkSlab::SetXMin(double p[3]) 
{
  this->SetXMin(p[0], p[1], p[2]);
}

inline void vtkSlab::SetXMax(double p[3]) 
{
