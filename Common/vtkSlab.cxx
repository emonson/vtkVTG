...
vtkCxxRevisionMacro(vtkSlab, "$Revision: 1.8 $");
vtkStandardNewMacro(vtkSlab);
...
void vtkSlab::SetBounds(double xMin, double xMax,
...
//----------------------------------------------------------------------------
void vtkSlab::SetBounds(double bounds[6])
{
...
//----------------------------------------------------------------------------
void vtkSlab::SetXMin(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void vtkSlab::SetXMax(double x, double y, double z)
{
  vtkDebugMacro(<< this->GetClassName() << " (" << this 
                << "): setting XMax to (" 
                << x  << "," << y << "," << z << ")"); 
...
//----------------------------------------------------------------------------
void vtkSlab::GetBounds(double &xMin, double &xMax,
                       double &yMin, double &yMax,
                       double &zMin, double &zMax)
{
...
//----------------------------------------------------------------------------
void vtkSlab::GetBounds(double bounds[6])
{
  this->BBox->GetBounds(bounds);
}

//----------------------------------------------------------------------------
double* vtkSlab::GetBounds()
{
...
//----------------------------------------------------------------------------
void vtkSlab::AddBounds(double bounds[6])
{
...
double vtkSlab::EvaluateFunction(double x[3])
{
...
void vtkSlab::EvaluateGradient(double x[3], double n[3])
{
...
char vtkSlab::IntersectBox (double bounds[6], double origin[3], double dir[3], 
...
//----------------------------------------------------------------------------
void vtkSlab::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkSlab::GetXMin(double p[3]) 
{
  this->BBox->GetMinPoint(p[0], p[1], p[2]);
}

//----------------------------------------------------------------------------
void vtkSlab::GetXMin(double &x , double &y, double &z)
{
  this->BBox->GetMinPoint(x, y, z);
}

//----------------------------------------------------------------------------
void vtkSlab::GetXMax(double p[3]) 
{
  this->BBox->GetMaxPoint(p[0], p[1], p[2]);
}

//----------------------------------------------------------------------------
void vtkSlab::GetXMax(double &x , double &y, double &z)
{
